...
class Datasource {
    fun loadWorldCup() : List<WorldCup> {
        return listOf<WorldCup>(
            ...
            WorldCup(R.drawable.croatian_logo,R.string.team3, R.string.uefa),
            WorldCup(R.drawable.brazilian_logo,R.string.team4, R.string.conmebol),
            ...
            WorldCup(R.drawable.portuguese_logo,R.string.team8, R.string.uefa)
        )
    }
}